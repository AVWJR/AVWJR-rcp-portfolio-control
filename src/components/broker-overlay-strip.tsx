...
export function BrokerOverlayStrip({ overlay }: { overlay: BrokerT12OverlaySummary | null }) {
  ...
  return (
    <section className="border border-gold-400 bg-cream-50 px-5 py-4 shadow-ledger">
      <p className="text-[11px] uppercase tracking-[0.2em] text-gold-700">Broker T12 overlay — not posted to the GL</p>
      ...
      <p className="mt-2 max-w-3xl text-sm text-ink-700">
        ...
        <strong>budget</strong> (source <code>broker_t12</code>). Period tiles above are books — they stay $0
        until journals are posted. Do not read this strip as audited GL.
      </p>
