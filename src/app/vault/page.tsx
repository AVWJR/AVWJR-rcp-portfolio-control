...
import { archiveImpactCopy } from "@/lib/archive";
            ...
            <div className="flex flex-wrap items-end justify-between gap-4">
              <div>
                ...
                <p className="mt-2 max-w-3xl text-sm text-ink-700">
                  ...
                  store. Soft-archived SPEs stay here for study; restore is on gold nav{" "}
              ...
              {role === "principal" && liveSpe ? (
                <SpeLifecycleDialog
                  ...
                  impact={archiveImpactCopy({ code: ctx.entity.code, name: ctx.entity.name })}
                  triggerLabel="Archive this deal…"
