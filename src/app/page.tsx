            ...
            <div className="grid gap-4 md:grid-cols-2">
              {[
                ...(role === "principal"
                  ...
                  : []),
                { href: "/deals", title: "Deals / SPE list", copy: "Live property SPEs plus saved Add Deal drafts. Archived deals are not here — use gold nav Archive." },
                ...(role === "principal"
                  ? [{ href: "/archive", title: "Deal Archive", copy: "Study soft-archived SPEs and restore them. Not a tab under Deals. Books and vault stay intact." }]
                  : []),
                ...
                { href: "/tax", title: "Books-to-tax bridge", copy: "Book NI / dep / interest / fees vs MACRS tax columns. Does not file." },
                { href: "/tax/k1", title: "Partner capital / K-1 export", copy: "Beg + contrib − dist ± book NI = end. CPA prep, not a filed K-1." },
                { href: "/vault", title: "Document vault", copy: "Leases, loans, K-1s, draws, insurance — metadata + blobs by entity." },
                { href: "/scheduler", title: "Scheduled reporting", copy: "Monthly investor / quarterly lender packs. Files + last-run status." },
                { href: "/vendors", title: "1099 vendor hooks", copy: "Vendor master + reportable overlay. Phase A AP has no invoice subledger." },
