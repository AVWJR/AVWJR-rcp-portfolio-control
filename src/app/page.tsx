            ...
            <div className="grid gap-4 md:grid-cols-2">
              {[
                ...(role === "principal"
                  ...
                  : []),
                { href: "/deals", title: "Deals / SPE list", copy: "Live property SPEs plus saved Add Deal drafts. LP/GP waterfall and deal proforma are on each SPE card. Deleted deals are not here — use gold nav Deal Archive." },
                ...(role === "principal"
