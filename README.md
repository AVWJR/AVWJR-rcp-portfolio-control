...
- **Narrative engine** — First-class `AudienceBrief` per LP, GP, Investment Committee, Lender, and Management Committee. Switching audience on `/narratives` changes **section outline, KPI chips, and infographics** — not just the title. Copy is plain professional English and cites key numbers with units. Regenerates when entity or period changes. IC memo includes a deterministic go / hold / fix.
