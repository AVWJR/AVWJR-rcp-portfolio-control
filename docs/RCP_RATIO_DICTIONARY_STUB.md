...
| `rcp_after_waterfall` | RCP cash after waterfall | Σ SPE GP/RCP cash-if-distributed + OpCo cash | usd_cents | — | ready | mixed |
...
- **After waterfall** — when a Principal saves an LP/GP template on Deals, OpCo **cash / CFADS / liquidity** use the GP/RCP share. Default remains 100% look-through. See [RCP_WATERFALL.md](./RCP_WATERFALL.md).
