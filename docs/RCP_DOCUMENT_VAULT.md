...
- `/vault` — list for the header entity, upload, download. On a **live SPE**, Principal sees **Archive this deal…** (soft-archive; books/vault stay). Restore is on gold nav **Archive** (`/archive`), not under Deals.
