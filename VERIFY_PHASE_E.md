...
| 3 | Narratives regenerate when period or entity changes and cite key numbers with units | Switch header to `2026-07` or `RCP-OPCO` · numbers and IC go/hold/kill update |
...
- IC memo includes a GO / HOLD / KILL action.
